function [N_max, tof, sol_all] = russell_algorithm(tau, p, h, s, mean_motion, r_b1, v_b1, r_b2, r0, v0, mu_b1, mu, rp_min, TR_min, AR_min, year2sec)
...
for i = 1:N_max+1
    ...
    for z = 1:4
        ...
        struct_temp.v_local         = v_inf_minus_local_all;
