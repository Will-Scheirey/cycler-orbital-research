...
ve_vec = [ve, 0, 0];
v_inf_vec = sqrt(3*10) * [1, 1, 1];

v_res_vec = ve_vec + v_inf_vec;
...
surf(x1, y1, z1, 'FaceAlpha', 0.1, 'FaceColor', 'blue', 'LineStyle','none', 'DisplayName', 'Earth Velocity Sphere'); hold on
...
plot3(x_intersect, y_intersect2, z_intersect, '-r', 'LineWidth', 5, 'HandleVisibility', 'off')
...
quiver3(0, 0, 0, v_res_vec(1), v_res_vec(2), v_res_vec(3),  0, 'LineWidth', 3, 'Color', 'green', 'DisplayName', 'Resulting Velocity')
